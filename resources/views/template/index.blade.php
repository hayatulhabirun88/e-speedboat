...
<head>
    ...
    <title>@yield('title') | E-Speedboat </title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="@yield('title')| E-Speedboat ">
    <meta name="author" content="ColorlibHQ">
    <meta name="description" content="@yield('title') | E-Speedboat.">
    <meta name="keywords"
    ...
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="/dashboard" class="brand-link">
                    <!--begin::Brand Image--> <img src="/logo.jpg" alt="AdminLTE Logo"
                        class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span
                        class="brand-text fw-light">E-Speedboat</span> <!--end::Brand Text--> </a>
                <!--end::Brand Link-->
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            <!--begin::Copyright--> <strong>
                Copyright &copy; 2024&nbsp;
                <a href="https://e-speedboat.my.id" class="text-decoration-none">Muh. Ikbal</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
